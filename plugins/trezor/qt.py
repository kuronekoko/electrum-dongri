...
from electrum_dongri.plugins import hook, DeviceMgr
from electrum_dongri.util import PrintError, UserCancelled, bh2u
from electrum_dongri.wallet import Wallet, Standard_Wallet
    ...
    def request_trezor_init_settings(self, wizard, method, model):
        ...
        if method in [TIM_NEW, TIM_RECOVER]:
            ...
            if method == TIM_MNEMONIC:
                ...
                def set_enabled():
                    from electrum_dongri.keystore import is_xprv
